...
//
//class PokeBaitItem(val pokeRodId: ResourceLocation, settings: Properties) {//: ThrowableItemProjectile(settings) {
//
//    companion object {
//        fun getBaitOnPokeBait(stack: ItemStack): FishingBait? {
...
//
//                if (baitCount > 1) {
//                    val fishingBait = getBaitOnPokeBait(stack) ?: return
...
//            return getBaitOnPokeBait(stack)?.effects ?: return emptyList()
//        }
//    }
//
//
