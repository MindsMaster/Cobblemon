...
/**
 * A spawning cause that is embellished with bait information. Could probably also
 * have the bait entity or something.
 *
 * @author Hiroku
 * @since February 3rd, 2024
 */
class BaitSpawnCause(
    spawner: Spawner,
    bucket: SpawnBucket,
    entity: Entity?,
    ...
    override fun affectSpawn(entity: Entity) {
        ...
        if (entity is PokemonEntity) {
            entity.pokemon.forcedAspects += BAIT_ASPECT
            ...
            CobblemonEvents.BAIT_SPAWN_POKEMON_MODIFY.post(BaitSpawnPokemonEvent.Modify(bucket, baitStack, entity))
        }
    }
