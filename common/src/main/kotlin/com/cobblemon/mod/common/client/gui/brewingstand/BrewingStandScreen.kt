...
class BrewingStandScreen(
    ...
    title: Component
) : AbstractContainerScreen<BrewingStandMenu>(menu, playerInventory, title) {

    companion object {
        private val FUEL_LENGTH_SPRITE = ResourceLocation.withDefaultNamespace("container/brewing_stand/fuel_length")
        private val BREW_PROGRESS_SPRITE = ResourceLocation.withDefaultNamespace("container/brewing_stand/brew_progress")
        private val BUBBLES_SPRITE = ResourceLocation.withDefaultNamespace("container/brewing_stand/bubbles")
        private val BREWING_STAND_LOCATION = ResourceLocation.withDefaultNamespace("textures/gui/container/brewing_stand.png")
    ...
    override fun renderBg(guiGraphics: GuiGraphics, partialTick: Float, mouseX: Int, mouseY: Int) {
        ...
        if (brewingTicks > 0) {
            ...
            if (bubbleHeight > 0) {
                guiGraphics.blitSprite(BUBBLES_SPRITE, 12, 29, 0, 29 - bubbleHeight, i + 63, j + 14 + 29 - bubbleHeight, 12, bubbleHeight)
            }
        }
    }
}
